...
const EditPage3Inch = () => {
	...
	<div
			...
			<div className="grid grid-cols-4 fixed bottom-20 w-full ">
				...
				<button   onClick={() => handleButtonClick("2")} className={`border-2 border-white h-14 rounded-md   mx-2 my-2 flex items-center justify-center ${isMinusClicked ? "bg-gray-800" : "bg-gray-800"}`} >
					<button > 2</button>
				</button>
				...
				<button   onClick={() => handleButtonClick("4")} className={`border-2 border-white h-14 rounded-md   mx-2 my-2 flex items-center justify-center ${isMinusClicked ? "bg-gray-800" : "bg-gray-800"}`} >
					<button > 4</button>
				</button>
				<button   onClick={() => handleButtonClick("5")} className={`border-2 border-white h-14 rounded-md   mx-2 my-2 flex items-center justify-center ${isMinusClicked ? "bg-gray-800" : "bg-gray-800"}`} >
					<button > 5</button>
				</button>
				...
				<button   onClick={() => handleButtonClick("7")} className={`border-2 border-white h-14 rounded-md   mx-2 my-2 flex items-center justify-center ${isMinusClicked ? "bg-gray-800" : "bg-gray-800"}`} >
					<button > 7</button>
				</button>
				<button   onClick={() => handleButtonClick("8")} className={`border-2 border-white h-14 rounded-md   mx-2 my-2 flex items-center justify-center ${isMinusClicked ? "bg-gray-800" : "bg-gray-800"}`} >
					<button > 8</button>
				</button>
				...
				<button disabled={isMinusClicked}  onClick={() => handleButtonClick(".")} className={`border-2 col-span-2 border-white h-14 rounded-md   mx-2 my-2 flex items-center justify-center ${isMinusClicked ? "bg-gray-800" : "bg-gray-800"}`} >
					<button >.</button>
				</button>
